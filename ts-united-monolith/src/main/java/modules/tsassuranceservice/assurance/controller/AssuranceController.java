package modules.tsassuranceservice.assurance.controller;
import java.util.UUID;
import modules.tsassuranceservice.assurance.service.AssuranceService;
...
public class AssuranceController {
    ...
    public HttpEntity getAllAssurances(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllAssuranceType(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteAssurance(@PathVariable
    String assuranceId, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteAssuranceByOrderId(@PathVariable
    ...
    String assuranceId, @PathVariable
    String orderId, @PathVariable
    int typeIndex, @RequestHeader
    HttpHeaders headers) {
        AssuranceController.LOGGER.info("[modifyAssurance][Modify Assurance][assuranceId: {}, orderId: {}, typeIndex: {}]", assuranceId, orderId, typeIndex);
        return ok(assuranceService.modify(assuranceId, orderId, typeIndex, headers));
    }

    @CrossOrigin(origins = "*")
    @GetMapping(path = "/assurances/{typeIndex}/{orderId}")
    public HttpEntity createNewAssurance(@PathVariable
    int typeIndex, @PathVariable
    String orderId, @RequestHeader
    HttpHeaders headers) {
        // Assurance
    ...
    public HttpEntity getAssuranceById(@PathVariable
    String assuranceId, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity findAssuranceByOrderId(@PathVariable
    String orderId, @RequestHeader
    HttpHeaders headers) {
