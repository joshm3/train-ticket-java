...
import modules.tsseatservice.TsseatserviceClient;
...
public class SeatServiceImpl implements SeatService {
    @Autowired
    TsseatserviceClient tsseatserviceClient;
    ...
    public Response distributeSeat(Seat seatRequest, HttpHeaders headers) {
        ...
        if (trainNumber.startsWith("G") || trainNumber.startsWith("D")) {
            ...
            re3 = tsseatserviceClient.postApiV1OrderserviceOrderTickets(seatRequest, null);
            ...
            re3 = tsseatserviceClient.postApiV1OrderotherserviceOrderotherTickets(seatRequest, null);
            SeatServiceImpl.LOGGER.info("[distributeSeat][Left ticket info][info is : {}]", re3.getBody().toString());
            leftTicketInfo = re3.getBody().getData();
        }
        // Assign seats
    ...
    private double getDirectProportion(HttpHeaders headers) {
        ...
        ResponseEntity<Response<Config>> re = tsseatserviceClient.getApiV1ConfigserviceConfigsPathvariable(null);
