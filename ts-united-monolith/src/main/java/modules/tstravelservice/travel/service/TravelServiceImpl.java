...
import modules.tstravelservice.TstravelserviceClient;
...
public class TravelServiceImpl implements TravelService {
    @Autowired
    TstravelserviceClient tstravelserviceClient;
    ...
    private List<TripResponse> getTicketsByBatch(List<Trip> trips, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tstravelserviceClient.postApiV1BasicserviceBasicTravels(infos, null);
    ...
    private TripResponse getTickets(Trip trip, Route route1, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        String basic_service_url = getServiceUrl("ts-basic-service");
        ResponseEntity<Response> re = tstravelserviceClient.postApiV1BasicserviceBasicTravel(query, null);
        Response r = re.getBody();
        if (r.getStatus() == 0) {
    ...
    private TrainType getTrainTypeByName(String trainTypeName, HttpHeaders headers) {
        ...
        ResponseEntity<Response<TrainType>> re = tstravelserviceClient.getApiV1TrainserviceTrainsBynamePathvariable(trainTypeName, null);
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tstravelserviceClient.getApiV1RouteserviceRoutesPathvariable(routeId, null);
    ...
    private int getRestTicketNumber(String travelDate, String trainNumber, String startStationName, String endStationName, int seatType, int totalNum, List<String> stationList, HttpHeaders headers) {
        ...
        ResponseEntity<Response<Integer>> re = tstravelserviceClient.postApiV1SeatserviceSeatsLeft_tickets(seatRequest, null);
