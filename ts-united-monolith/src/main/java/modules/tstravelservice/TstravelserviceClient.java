...
@Component
public class TstravelserviceClient {
    @Autowired
    ...
    public ResponseEntity<Response> postApiV1BasicserviceBasicTravels(List<Travel> list9, HttpHeaders httpheaders10) {
        ...
        if (list9 != null) {
            ...
            for (Travel listType2 : list9) {
                modules.tscommon.edu.fudan.common.entity.Travel output3 = new modules.tscommon.edu.fudan.common.entity.Travel();
                Trip field4 = listType2.getTrip();
                modules.tscommon.edu.fudan.common.entity.Trip output5 = new modules.tscommon.edu.fudan.common.entity.Trip();
    ...
    public ResponseEntity<Response> postApiV1BasicserviceBasicTravel(Travel travel28, HttpHeaders httpheaders29) {
        ...
        if (travel28 != null) {
            ...
            Trip field2 = travel28.getTrip();
            modules.tscommon.edu.fudan.common.entity.Trip output3 = new modules.tscommon.edu.fudan.common.entity.Trip();
        ...
        Response local22 = null;
        try  {
            com.fasterxml.jackson.databind.ObjectMapper mapper = new com.fasterxml.jackson.databind.ObjectMapper();
            mapper.configure(com.fasterxml.jackson.databind.DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
            mapper.registerModule(new com.fasterxml.jackson.datatype.jdk8.Jdk8Module());
            byte[] bytes = mapper.writeValueAsBytes(local21);
            local22 = mapper.readValue(bytes, new TypeReference<Response>() {});
        } catch (Exception e) {
            System.err.println(e.toString());
        }
        ...
        ResponseEntity<Response> output25 = new ResponseEntity<Response>(local22, local24, HttpStatus.CREATED);
        return output25;
    }
