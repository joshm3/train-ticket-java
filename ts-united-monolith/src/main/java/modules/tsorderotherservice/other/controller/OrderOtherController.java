package modules.tsorderotherservice.other.controller;
...
public class OrderOtherController {
     ...
     * *************************For Normal Use**************************
     */
    @PostMapping("/orderOther/tickets")
    ...
    OrderFromtsorderotherservice createOrder, @RequestHeader
    HttpHeaders headers) {
    ...
    OrderFromtsorderotherservice order, @RequestHeader
    HttpHeaders headers) {
    ...
    OrderFromtsorderotherservice orderInfo, @RequestHeader
    HttpHeaders headers) {
