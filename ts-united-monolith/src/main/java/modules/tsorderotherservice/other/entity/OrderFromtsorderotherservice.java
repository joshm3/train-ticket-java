package modules.tsorderotherservice.other.entity;
...
public class OrderFromtsorderotherservice {
    @Id
    @Column(length = 36)
    ...
    public OrderFromtsorderotherservice() {
