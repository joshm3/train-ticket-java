...
import modules.tspreserveservice.TspreserveserviceClient;
...
public class PreserveServiceImpl implements PreserveService {
    @Autowired
    TspreserveserviceClient tspreserveserviceClient;
    ...
    public Response preserve(OrderTicketsInfo oti, HttpHeaders headers) {
        ...
        ResponseEntity<Response<TravelResult>> re = tspreserveserviceClient.postApiV1BasicserviceBasicTravel(query, headers);
    ...
    public Ticket dipatchSeat(String date, String tripId, String startStation, String endStataion, int seatType, int totalNum, List<String> stationList, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Ticket>> reTicket = tspreserveserviceClient.postApiV1SeatserviceSeats(seatRequest, httpHeaders);
    ...
    public User getAccount(String accountId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<User>> getAccount = tspreserveserviceClient.getApiV1UserserviceUsersIdPathvariable(accountId, httpHeaders);
    ...
    private Response addAssuranceForOrder(int assuranceType, String orderId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reAddAssuranceResult = tspreserveserviceClient.getApiV1AssuranceserviceAssurancesPathvariablePathvariable(assuranceType, orderId, httpHeaders);
    ...
    private String queryForStationId(String stationName, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<String>> reQueryForStationId = tspreserveserviceClient.getApiV1StationserviceStationsIdPathvariable(stationName, httpHeaders);
    ...
    private Response checkSecurity(String accountId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reCheckResult = tspreserveserviceClient.getApiV1SecurityserviceSecurityconfigsPathvariable(accountId, httpHeaders);
    ...
    private Response<TripAllDetail> getTripAllDetailInformation(TripAllDetailInfo gtdi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<TripAllDetail>> reGetTripAllDetailResult = tspreserveserviceClient.postApiV1TravelserviceTrip_detail(gtdi, httpHeaders);
    ...
    private Response<Contacts> getContactsById(String contactsId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Contacts>> reGetContactsResult = tspreserveserviceClient.getApiV1ContactserviceContactsPathvariable(contactsId, httpHeaders);
    ...
    private Response createOrder(Order coi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Order>> reCreateOrderResult = tspreserveserviceClient.postApiV1OrderserviceOrder(coi, httpHeaders);
    ...
    private Response createFoodOrder(FoodOrder afi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reAddFoodOrderResult = tspreserveserviceClient.postApiV1FoodserviceOrders(afi, httpHeaders);
    ...
    private Response createConsign(Consign cr, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reResultForTravel = tspreserveserviceClient.postApiV1ConsignserviceConsigns(cr, httpHeaders);
