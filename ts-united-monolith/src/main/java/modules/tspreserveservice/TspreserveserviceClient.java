package modules.tspreserveservice;
...
@Component
public class TspreserveserviceClient {
    @Autowired
    ...
    public ResponseEntity<Response<TravelResult>> postApiV1BasicserviceBasicTravel(Travel travel9, HttpHeaders httpheaders10) {
        Travel local0;
        if (travel9 != null) {
            Travel output1 = new Travel();
            Trip field2 = travel9.getTrip();
            ...
            String field16 = travel9.getStartPlace();
            output1.setStartPlace(field16);
            String field17 = travel9.getEndPlace();
            output1.setEndPlace(field17);
            String field18 = travel9.getDepartureTime();
    ...
    public ResponseEntity<Response> getApiV1AssuranceserviceAssurancesPathvariablePathvariable(int int8, String string9, HttpHeaders httpheaders10) {
        int local0;
        String local1;
        if (string9 != null) {
            local1 = string9;
    ...
    public ResponseEntity<Response<TripAllDetail>> postApiV1TravelserviceTrip_detail(TripAllDetailInfo tripalldetailinfo8, HttpHeaders httpheaders9) {
    ...
    public ResponseEntity<Response<Order>> postApiV1OrderserviceOrder(Order order8, HttpHeaders httpheaders9) {
