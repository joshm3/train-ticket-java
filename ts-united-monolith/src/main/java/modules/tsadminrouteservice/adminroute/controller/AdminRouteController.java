package modules.tsadminrouteservice.adminroute.controller;
import modules.tsadminrouteservice.adminroute.service.AdminRouteService;
...
public class AdminRouteController {
    ...
    public HttpEntity getAllRoutes(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity addRoute(@RequestBody
    RouteInfo request, @RequestHeader
    HttpHeaders headers) {
        logger.info("[addRoute][Create and modify route][route id: {}, from station {} to station {}]", request.getId(), request.getStartStation(), request.getEndStation());
