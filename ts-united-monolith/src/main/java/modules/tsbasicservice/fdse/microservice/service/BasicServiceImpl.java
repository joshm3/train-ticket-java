...
import java.util.*;
import modules.tsbasicservice.TsbasicserviceClient;
import modules.tscommon.edu.fudan.common.entity.PriceConfig;
...
public class BasicServiceImpl implements BasicService {
    @Autowired
    TsbasicserviceClient tsbasicserviceClient;
    ...
    public Response queryForStationId(String stationName, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsbasicserviceClient.getApiV1StationserviceStationsIdPathvariable(stationName, null);
    ...
    public Map<String, String> checkStationsExists(List<String> stationNames, HttpHeaders headers) {
        ...
        String station_service_url = getServiceUrl("ts-station-service");
        ResponseEntity<Response> re = tsbasicserviceClient.postApiV1StationserviceStationsIdlist(stationNames, null);
    ...
    public List<TrainType> queryTrainTypeByNames(List<String> trainTypeNames, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsbasicserviceClient.postApiV1TrainserviceTrainsBynames(trainTypeNames, null);
    ...
    public TrainType queryTrainTypeByName(String trainTypeName, HttpHeaders headers) {
        ...
        HttpEntity requestEntity = new HttpEntity(null);
        String train_service_url = getServiceUrl("ts-train-service");
        ResponseEntity<Response> re = tsbasicserviceClient.getApiV1TrainserviceTrainsBynamePathvariable(trainTypeName, null);
    ...
    private List<Route> getRoutesByRouteIds(List<String> routeIds, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsbasicserviceClient.postApiV1RouteserviceRoutesByids(routeIds, null);
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
        ...
        HttpEntity requestEntity = new HttpEntity(null);
        String route_service_url = getServiceUrl("ts-route-service");
        ResponseEntity<Response> re = tsbasicserviceClient.getApiV1RouteserviceRoutesPathvariable(routeId, null);
    ...
    private PriceConfig queryPriceConfigByRouteIdAndTrainType(String routeId, String trainType, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsbasicserviceClient.getApiV1PriceservicePricesPathvariablePathvariable(routeId, trainType, null);
        Response result = re.getBody();
    ...
    private Map<String, PriceConfig> queryPriceConfigByRouteIdsAndTrainTypes(List<String> routeIdsTypes, HttpHeaders headers) {
        ...
        String price_service_url = getServiceUrl("ts-price-service");
        ResponseEntity<Response> re = tsbasicserviceClient.postApiV1PriceservicePricesByrouteidsandtraintypes(routeIdsTypes, null);
