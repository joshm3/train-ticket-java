package modules.tsadmintravelservice.admintravel.service;
import java.util.ArrayList;
import java.util.List;
import java.util.Map;
import modules.tsadmintravelservice.TsadmintravelserviceClient;
...
public class AdminTravelServiceImpl implements AdminTravelService {
    @Autowired
    TsadmintravelserviceClient tsadmintravelserviceClient;
    ...
    public Response getAllTravels(HttpHeaders headers) {
        ...
        ResponseEntity<Response<ArrayList<AdminTrip>>> re = tsadmintravelserviceClient.getApiV1TravelserviceAdmin_trip(headers);
        result = re.getBody();
        ...
        ResponseEntity<Response<ArrayList<AdminTrip>>> re2 = tsadmintravelserviceClient.getApiV1Travel2serviceAdmin_trip(headers);
        result = re2.getBody();
        if (result.getStatus() == 1) {
    ...
    public Response addTravel(TravelInfo request, HttpHeaders headers) {
        ...
        if ((tripId.charAt(0) == 'G') || (tripId.charAt(0) == 'D')) {
            ...
            re = tsadmintravelserviceClient.postApiV1TravelserviceTrips(request, headers);
        } else {
            requestUrl = travel2_service_url + "/api/v1/travel2service/trips";
            re = tsadmintravelserviceClient.postApiV1Travel2serviceTrips(request, headers);
        }
        result = re.getBody();
        if (result.getStatus() == 1) {
    ...
    public Response updateTravel(TravelInfo request, HttpHeaders headers) {
        ...
        if ((tripId.charAt(0) == 'G') || (tripId.charAt(0) == 'D')) {
            requestUrl = travel_service_url + "/api/v1/travelservice/trips";
            re = tsadmintravelserviceClient.putApiV1TravelserviceTrips(request, headers);
        } else {
            requestUrl = travel2_service_url + "/api/v1/travel2service/trips";
            re = tsadmintravelserviceClient.putApiV1Travel2serviceTrips(request, headers);
        }
        result = re.getBody();
        if (result.getStatus() != 1) {
    ...
    public Response deleteTravel(String tripId, HttpHeaders headers) {
        ...
        if ((tripId.charAt(0) == 'G') || (tripId.charAt(0) == 'D')) {
            ...
            re = tsadmintravelserviceClient.deleteApiV1TravelserviceTripsPathvariable(tripId, headers);
        } else {
            requestUtl = (travel2_service_url + "/api/v1/travel2service/trips/") + tripId;
            re = tsadmintravelserviceClient.deleteApiV1Travel2serviceTripsPathvariable(tripId, headers);
        }
        result = re.getBody();
        if (result.getStatus() != 1) {
    ...
    public Response checkTravelInfo(TravelInfo info, HttpHeaders headers) {
        ...
        if (trainType == null) {
            AdminTravelServiceImpl.LOGGER.warn("[queryForTravel][traintype doesn't exist][trainTypeName: {}]", info.getTrainTypeName());
    ...
    public Response checkStationsExists(List<String> stationNames, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsadmintravelserviceClient.postApiV1StationserviceStationsIdlist(stationNames, null);
    ...
    public TrainType queryTrainTypeByName(String trainTypeName, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsadmintravelserviceClient.getApiV1TrainserviceTrainsBynamePathvariable(trainTypeName, null);
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tsadmintravelserviceClient.getApiV1RouteserviceRoutesPathvariable(routeId, null);
