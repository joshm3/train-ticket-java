...
import modules.tspreserveotherservice.TspreserveotherserviceClient;
...
public class PreserveOtherServiceImpl implements PreserveOtherService {
    @Autowired
    TspreserveotherserviceClient tspreserveotherserviceClient;
    ...
    public Response preserve(OrderTicketsInfo oti, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<TravelResult>> re = tspreserveotherserviceClient.postApiV1BasicserviceBasicTravel(query, httpHeaders);
    ...
    public Ticket dipatchSeat(String date, String tripId, String startStationId, String endStataionId, int seatType, int totalNum, List<String> stationList, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Ticket>> reTicket = tspreserveotherserviceClient.postApiV1SeatserviceSeats(seatRequest, httpHeaders);
    ...
    public User getAccount(String accountId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<User>> getAccount = tspreserveotherserviceClient.getApiV1UserserviceUsersIdPathvariable(accountId, httpHeaders);
    ...
    private Response<Assurance> addAssuranceForOrder(int assuranceType, String orderId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Assurance>> reAddAssuranceResult = tspreserveotherserviceClient.getApiV1AssuranceserviceAssurancesPathvariablePathvariable(assuranceType, orderId, httpHeaders);
    ...
    private String queryForStationId(String stationName, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<String>> reQueryForStationId = tspreserveotherserviceClient.getApiV1StationserviceStationsIdPathvariable(stationName, httpHeaders);
    ...
    private Response checkSecurity(String accountId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reCheckResult = tspreserveotherserviceClient.getApiV1SecurityserviceSecurityconfigsPathvariable(accountId, httpHeaders);
    ...
    private Response<TripAllDetail> getTripAllDetailInformation(TripAllDetailInfo gtdi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<TripAllDetail>> reGetTripAllDetailResult = tspreserveotherserviceClient.postApiV1Travel2serviceTrip_detail(gtdi, httpHeaders);
    ...
    private Response<Contacts> getContactsById(String contactsId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Contacts>> reGetContactsResult = tspreserveotherserviceClient.getApiV1ContactserviceContactsPathvariable(contactsId, httpHeaders);
    ...
    private Response<Order> createOrder(Order coi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Order>> reCreateOrderResult = tspreserveotherserviceClient.postApiV1OrderotherserviceOrderother(coi, httpHeaders);
    ...
    private Response createFoodOrder(FoodOrder afi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reAddFoodOrderResult = tspreserveotherserviceClient.postApiV1FoodserviceOrders(afi, httpHeaders);
    ...
    private Response createConsign(Consign cr, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reResultForTravel = tspreserveotherserviceClient.postApiV1ConsignserviceConsigns(cr, httpHeaders);
