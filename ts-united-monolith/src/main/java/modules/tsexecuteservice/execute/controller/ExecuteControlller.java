package modules.tsexecuteservice.execute.controller;
import modules.tsexecuteservice.execute.serivce.ExecuteService;
...
public class ExecuteControlller {
    ...
    public HttpEntity executeTicket(@PathVariable
    ...
    public HttpEntity collectTicket(@PathVariable
    String orderId, @RequestHeader
    HttpHeaders headers) {
