...
import modules.tstravelplanservice.TstravelplanserviceClient;
...
public class TravelPlanServiceImpl implements TravelPlanService {
    @Autowired
    TstravelplanserviceClient tstravelplanserviceClient;
    ...
    private int getRestTicketNumber(String travelDate, String trainNumber, String startStationName, String endStationName, int seatType, int totalNum, List<String> stations, HttpHeaders headers) {
        ...
        ResponseEntity<Response<Integer>> re = tstravelplanserviceClient.postApiV1SeatserviceSeatsLeft_tickets(seatRequest, null);
    ...
    private ArrayList<RoutePlanResultUnit> getRoutePlanResultCheapest(RoutePlanInfo info, HttpHeaders headers) {
        ...
        ResponseEntity<Response<ArrayList<RoutePlanResultUnit>>> re = tstravelplanserviceClient.postApiV1RouteplanserviceRouteplanCheapestroute(info, null);
        return re.getBody().getData();
    }
    ...
    private ArrayList<RoutePlanResultUnit> getRoutePlanResultQuickest(RoutePlanInfo info, HttpHeaders headers) {
        HttpEntity requestEntity = new HttpEntity(info, null);
        String route_plan_service_url = getServiceUrl("ts-route-plan-service");
        ResponseEntity<Response<ArrayList<RoutePlanResultUnit>>> re = tstravelplanserviceClient.postApiV1RouteplanserviceRouteplanQuickestroute(info, null);
        return re.getBody().getData();
    }
    ...
    private ArrayList<RoutePlanResultUnit> getRoutePlanResultMinStation(RoutePlanInfo info, HttpHeaders headers) {
        HttpEntity requestEntity = new HttpEntity(info, null);
        String route_plan_service_url = getServiceUrl("ts-route-plan-service");
        ResponseEntity<Response<ArrayList<RoutePlanResultUnit>>> re = tstravelplanserviceClient.postApiV1RouteplanserviceRouteplanMinstopstations(info, null);
        return re.getBody().getData();
    }
    ...
    private List<TripResponse> tripsFromHighSpeed(TripInfo info, HttpHeaders headers) {
        ...
        ResponseEntity<Response<List<TripResponse>>> re = tstravelplanserviceClient.postApiV1TravelserviceTripsLeft(info, null);
        return re.getBody().getData();
    }
    ...
    private ArrayList<TripResponse> tripsFromNormal(TripInfo info, HttpHeaders headers) {
        ...
        ResponseEntity<Response<ArrayList<TripResponse>>> re = tstravelplanserviceClient.postApiV1Travel2serviceTripsLeft(info, null);
        return re.getBody().getData();
    }
    ...
    public TrainType queryTrainTypeByName(String trainTypeName, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tstravelplanserviceClient.getApiV1TrainserviceTrainsBynamePathvariable(trainTypeName, null);
