package modules.tsadminbasicinfoservice.adminbasic.controller;
import modules.tsadminbasicinfoservice.adminbasic.entity.PriceInfo;
import modules.tsadminbasicinfoservice.adminbasic.service.AdminBasicInfoService;
...
public class AdminBasicInfoController {
    ...
    public HttpEntity addContacts(@RequestBody
    Contacts c, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllStations(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteStation(@PathVariable
    ...
    public HttpEntity modifyStation(@RequestBody
    Station s, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity addStation(@RequestBody
    Station s, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllTrains(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteTrain(@PathVariable
    String id, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity modifyTrain(@RequestBody
    ...
    public HttpEntity addTrain(@RequestBody
    TrainType t, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllConfigs(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteConfig(@PathVariable
    ...
    public HttpEntity modifyConfig(@RequestBody
    Config c, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity addConfig(@RequestBody
    Config c, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllPrices(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deletePrice(@PathVariable
    ...
    public HttpEntity modifyPrice(@RequestBody
    PriceInfo pi, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity addPrice(@RequestBody
    PriceInfo pi, @RequestHeader
    HttpHeaders headers) {
