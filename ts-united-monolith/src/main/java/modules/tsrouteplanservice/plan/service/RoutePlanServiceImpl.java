...
import modules.tsrouteplanservice.TsrouteplanserviceClient;
...
public class RoutePlanServiceImpl implements RoutePlanService {
    @Autowired
    TsrouteplanserviceClient tsrouteplanserviceClient;
    ...
    public Response searchMinStopStations(RoutePlanInfo info, HttpHeaders headers) {
        ...
        ResponseEntity<Response<ArrayList<Route>>> re = tsrouteplanserviceClient.getApiV1RouteserviceRoutesPathvariablePathvariable(info.getStartStation(), info.getEndStation(), null);
        ...
        ResponseEntity<Response<ArrayList<ArrayList<Trip>>>> re2 = tsrouteplanserviceClient.postApiV1TravelserviceTripsRoutes(resultRoutes, null);
        ArrayList<ArrayList<Trip>> travelTrips = re2.getBody().getData();
        String travel2_service_url = getServiceUrl("ts-travel2-service");
        re2 = tsrouteplanserviceClient.postApiV1Travel2serviceTripsRoutes(resultRoutes, null);
        ...
        for (Trip trip : trips) {
            ...
            if ((trip.getTripId().toString().charAt(0) == 'D') || (trip.getTripId().toString().charAt(0) == 'G')) {
                ...
                re3 = tsrouteplanserviceClient.postApiV1TravelserviceTrip_detail(allDetailInfo, null);
            } else {
                requestUrl = travel2_service_url + "/api/v1/travel2service/trip_detail";
                re3 = tsrouteplanserviceClient.postApiV1Travel2serviceTrip_detail(allDetailInfo, null);
            }
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
        HttpEntity requestEntity = new HttpEntity(null);
        String route_service_url = getServiceUrl("ts-route-service");
        ResponseEntity<Response<Route>> re = tsrouteplanserviceClient.getApiV1RouteserviceRoutesPathvariable(routeId, null);
    ...
    private ArrayList<TripResponse> getTripFromHighSpeedTravelServive(TripInfo info, HttpHeaders headers) {
        ...
        String travel_service_url = getServiceUrl("ts-travel-service");
        ResponseEntity<Response<ArrayList<TripResponse>>> re = tsrouteplanserviceClient.postApiV1TravelserviceTripsLeft(info, null);
    ...
    private ArrayList<TripResponse> getTripFromNormalTrainTravelService(TripInfo info, HttpHeaders headers) {
        HttpEntity requestEntity = new HttpEntity(info, null);
        String travel2_service_url = getServiceUrl("ts-travel2-service");
        ResponseEntity<Response<ArrayList<TripResponse>>> re = tsrouteplanserviceClient.postApiV1Travel2serviceTripsLeft(info, null);
    ...
    private List<String> getStationList(String tripId, HttpHeaders headers) {
        ...
        String travel2_service_url = getServiceUrl("ts-travel2-service");
        HttpEntity requestEntity = new HttpEntity(null);
        ResponseEntity<Response<Route>> re = null;
        if ((tripId.charAt(0) == 'G') || (tripId.charAt(0) == 'D')) {
            path = (travel_service_url + "/api/v1/travelservice/routes/") + tripId;
            re = tsrouteplanserviceClient.getApiV1TravelserviceRoutesPathvariable(tripId, null);
        } else {
            path = (travel2_service_url + "/api/v1/travel2service/routes/") + tripId;
            re = tsrouteplanserviceClient.getApiV1Travel2serviceRoutesPathvariable(tripId, null);
        }
