...
import modules.tsuserservice.TsuserserviceClient;
...
public class UserServiceImpl implements UserService {
    @Autowired
    TsuserserviceClient tsuserserviceClient;
    ...
    private Response createDefaultAuthUser(AuthDto dto) {
        ...
        ResponseEntity<Response<AuthDto>> res = tsuserserviceClient.postApiV1Auth(dto);
        return res.getBody();
    }
    ...
    public void deleteUserAuth(String userId, HttpHeaders headers) {
        ...
        tsuserserviceClient.deleteApiV1UsersPathvariable(userId, newHeaders);
