...
import modules.tsconsignservice.TsconsignserviceClient;
import modules.tsconsignservice.consign.entity.Consign;
import modules.tsconsignservice.consign.entity.ConsignRecord;
import modules.tsconsignservice.consign.repository.ConsignRepository;
...
public class ConsignServiceImpl implements ConsignService {
    @Autowired
    TsconsignserviceClient tsconsignserviceClient;
    ...
    public Response insertConsignRecord(Consign consignRequest, HttpHeaders headers) {
        ...
        ResponseEntity<Response<Double>> re = tsconsignserviceClient.getApiV1ConsignpriceserviceConsignpricePathvariablePathvariable(consignRequest.getWeight(), consignRequest.isWithin(), headers);
