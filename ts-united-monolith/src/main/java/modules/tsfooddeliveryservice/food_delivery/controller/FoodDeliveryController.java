package modules.tsfooddeliveryservice.food_delivery.controller;
...
import modules.tsfooddeliveryservice.food_delivery.service.FoodDeliveryService;
...
public class FoodDeliveryController {
    ...
    @PostMapping("/orders")
    public HttpEntity createFoodDeliveryOrder(@RequestBody
    FoodDeliveryOrder fd, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteFoodDeliveryOrder(@PathVariable
    ...
    public HttpEntity getFoodDeliveryOrderById(@PathVariable
    String orderId, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllFoodDeliveryOrders(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getFoodDeliveryOrderByStoreId(@PathVariable
    String storeId, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity updateTripId(@RequestBody
    TripOrderInfo tripOrderInfo, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity updateSeatNo(@RequestBody
    SeatInfo seatInfo, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity updateDeliveryTime(@RequestBody
    DeliveryInfo deliveryInfo, @RequestHeader
    HttpHeaders headers) {
