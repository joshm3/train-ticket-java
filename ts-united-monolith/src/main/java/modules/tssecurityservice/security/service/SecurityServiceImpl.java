...
import modules.tssecurityservice.TssecurityserviceClient;
...
public class SecurityServiceImpl implements SecurityService {
    @Autowired
    TssecurityserviceClient tssecurityserviceClient;
    ...
    private OrderSecurity getSecurityOrderInfoFromOrder(Date checkDate, String accountId, HttpHeaders headers) {
        ...
        ResponseEntity<Response<OrderSecurity>> re = tssecurityserviceClient.getApiV1OrderserviceOrderSecurityPathvariablePathvariable(checkDate, accountId, null);
    ...
    private OrderSecurity getSecurityOrderOtherInfoFromOrder(Date checkDate, String accountId, HttpHeaders headers) {
        ...
        ResponseEntity<Response<OrderSecurity>> re = tssecurityserviceClient.getApiV1OrderotherserviceOrderotherSecurityPathvariablePathvariable(checkDate, accountId, null);
        Response<OrderSecurity> response = re.getBody();
        OrderSecurity result = response.getData();
