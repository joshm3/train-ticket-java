package modules.tsadminorderservice.adminorder.controller;
import modules.tsadminorderservice.adminorder.service.AdminOrderService;
...
public class AdminOrderController {
    ...
    public HttpEntity getAllOrders(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity addOrder(@RequestBody
    Order request, @RequestHeader
    HttpHeaders headers) {
