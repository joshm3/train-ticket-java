package modules.tsstationfoodservice.food.controller;
import java.util.List;
import modules.tsstationfoodservice.food.service.StationFoodService;
...
public class StationFoodController {
    ...
    public HttpEntity getAllFoodStores(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getFoodStoresOfStation(@PathVariable
    ...
    public HttpEntity getFoodStoresByStationNames(@RequestBody
    ...
    public HttpEntity getFoodListByStationFoodStoreId(@PathVariable
    String stationFoodStoreId, @RequestHeader
    HttpHeaders headers) {
