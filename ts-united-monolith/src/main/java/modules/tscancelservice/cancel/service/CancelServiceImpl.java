...
import modules.tscancelservice.TscancelserviceClient;
...
public class CancelServiceImpl implements CancelService {
    @Autowired
    TscancelserviceClient tscancelserviceClient;
    ...
    public boolean sendEmail(NotifyInfo notifyInfo, HttpHeaders headers) {
        ...
        ResponseEntity<Boolean> re = tscancelserviceClient.postApiV1NotifyserviceNotificationOrder_cancel_success(notifyInfo, newHeaders);
        return re.getBody();
    }
    ...
    private Response cancelFromOrder(Order order, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tscancelserviceClient.putApiV1OrderserviceOrder(order, newHeaders);
        return re.getBody();
    }
    ...
    private Response cancelFromOtherOrder(Order order, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tscancelserviceClient.putApiV1OrderotherserviceOrderother(order, newHeaders);
        return re.getBody();
    }
    ...
    public boolean drawbackMoney(String money, String userId, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = tscancelserviceClient.getApiV1Inside_pay_serviceInside_paymentDrawbackPathvariablePathvariable(userId, money, newHeaders);
    ...
    public Response<User> getAccount(String orderId, HttpHeaders headers) {
        ...
        ResponseEntity<Response<User>> re = tscancelserviceClient.getApiV1UserserviceUsersIdPathvariable(orderId, newHeaders);
        return re.getBody();
    }
    ...
    private Response<Order> getOrderByIdFromOrder(String orderId, HttpHeaders headers) {
        ...
        HttpEntity requestEntity = new HttpEntity(newHeaders);
        String order_service_url = getServiceUrl("ts-order-service");
        ResponseEntity<Response<Order>> re = tscancelserviceClient.getApiV1OrderserviceOrderPathvariable(orderId, newHeaders);
        return re.getBody();
    }
    ...
    private Response<Order> getOrderByIdFromOrderOther(String orderId, HttpHeaders headers) {
        ...
        HttpEntity requestEntity = new HttpEntity(newHeaders);
        String order_other_service_url = getServiceUrl("ts-order-other-service");
        ResponseEntity<Response<Order>> re = tscancelserviceClient.getApiV1OrderotherserviceOrderotherPathvariable(orderId, newHeaders);
        return re.getBody();
    }
}