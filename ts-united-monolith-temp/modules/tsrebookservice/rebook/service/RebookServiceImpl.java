...
public class RebookServiceImpl implements RebookService {
    ...
    private Response<TripAllDetail> getTripAllDetailInformation(TripAllDetailInfo gtdi, String tripId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<TripAllDetail>> reGetTripAllDetailResult = restTemplate.exchange(requestUrl, HttpMethod.POST, requestGetTripAllDetailResult, new ParameterizedTypeReference<Response<TripAllDetail>>() {});
    ...
    private Response createOrder(Order order, String tripId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reCreateOrder = restTemplate.exchange(requestUrl, HttpMethod.POST, requestCreateOrder, Response.class);
    ...
    private Response updateOrder(Order info, String tripId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reUpdateOrder = restTemplate.exchange(requestOrderUtl, HttpMethod.PUT, requestUpdateOrder, Response.class);
    ...
    private Response deleteOrder(String orderId, String tripId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reDeleteOrder = restTemplate.exchange(requestUrl, HttpMethod.POST, requestDeleteOrder, Response.class);
    ...
    private Response<Order> getOrderByRebookInfo(RebookInfo info, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Order>> reGetOrderByRebookInfo = restTemplate.exchange(requestUrl, HttpMethod.GET, requestEntityGetOrderByRebookInfo, new ParameterizedTypeReference<Response<Order>>() {});
    ...
    private boolean payDifferentMoney(String orderId, String tripId, String userId, String money, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> rePayDifferentMoney = restTemplate.exchange(inside_payment_service_url + "/api/v1/inside_pay_service/inside_payment/difference", HttpMethod.POST, requestEntityPayDifferentMoney, Response.class);
    ...
    private boolean drawBackMoney(String userId, String money, HttpHeaders httpHeaders) {
        ...
        String inside_payment_service_url = getServiceUrl("ts-inside-payment-service");
        ResponseEntity<Response> reDrawBackMoney = restTemplate.exchange((((inside_payment_service_url + "/api/v1/inside_pay_service/inside_payment/drawback/") + userId) + "/") + money, HttpMethod.GET, requestEntityDrawBackMoney, Response.class);
