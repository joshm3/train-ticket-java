package modules.tsconfigservice.config.controller;
...
public class ConfigController {
    ...
    @CrossOrigin(origins = "*")
    @PostMapping("/configs")
    public HttpEntity<?> createConfig(@RequestBody
    Config info, @RequestHeader
    HttpHeaders headers) {
    ...
    @CrossOrigin(origins = "*")
    @PutMapping("/configs")
    public HttpEntity updateConfig(@RequestBody
    Config info, @RequestHeader
    HttpHeaders headers) {
    ...
    String configName, @RequestHeader
    HttpHeaders headers) {
