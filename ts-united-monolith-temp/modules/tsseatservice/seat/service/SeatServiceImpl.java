...
public class SeatServiceImpl implements SeatService {
    ...
    public Response distributeSeat(Seat seatRequest, HttpHeaders headers) {
        ...
        if (trainNumber.startsWith("G") || trainNumber.startsWith("D")) {
            ...
            re3 = restTemplate.exchange(order_service_url + "/api/v1/orderservice/order/tickets", HttpMethod.POST, requestEntity, new ParameterizedTypeReference<Response<LeftTicketInfo>>() {});
            ...
            re3 = restTemplate.exchange(order_other_service_url + "/api/v1/orderOtherService/orderOther/tickets", HttpMethod.POST, requestEntity, new ParameterizedTypeReference<Response<LeftTicketInfo>>() {});
            SeatServiceImpl.LOGGER.info("[distributeSeat][Left ticket info][info is : {}]", re3.getBody().toString());
            leftTicketInfo = re3.getBody().getData();
        }
        // Assign seats
    ...
    private double getDirectProportion(HttpHeaders headers) {
        ...
        ResponseEntity<Response<Config>> re = restTemplate.exchange((config_service_url + "/api/v1/configservice/configs/") + configName, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<Config>>() {});
