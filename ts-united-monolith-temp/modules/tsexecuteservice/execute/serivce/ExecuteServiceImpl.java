...
public class ExecuteServiceImpl implements ExecuteService {
    ...
    private Response executeOrder(String orderId, int status, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange((((order_service_url + "/api/v1/orderservice/order/status/") + orderId) + "/") + status, HttpMethod.GET, requestEntity, Response.class);
        return re.getBody();
    }
    ...
    private Response executeOrderOther(String orderId, int status, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange((((order_other_service_url + "/api/v1/orderOtherService/orderOther/status/") + orderId) + "/") + status, HttpMethod.GET, requestEntity, Response.class);
        return re.getBody();
    }
