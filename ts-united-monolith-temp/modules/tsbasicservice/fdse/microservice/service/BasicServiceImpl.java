...
public class BasicServiceImpl implements BasicService {
    ...
    public Response queryForStationId(String stationName, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange((station_service_url + "/api/v1/stationservice/stations/id/") + stationName, HttpMethod.GET, requestEntity, Response.class);
    ...
    public List<TrainType> queryTrainTypeByNames(List<String> trainTypeNames, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange(train_service_url + "/api/v1/trainservice/trains/byNames", HttpMethod.POST, requestEntity, Response.class);
    ...
    private PriceConfig queryPriceConfigByRouteIdAndTrainType(String routeId, String trainType, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange((((price_service_url + "/api/v1/priceservice/prices/") + routeId) + "/") + trainType, HttpMethod.GET, requestEntity, Response.class);
        Response result = re.getBody();
    ...
    private Map<String, PriceConfig> queryPriceConfigByRouteIdsAndTrainTypes(List<String> routeIdsTypes, HttpHeaders headers) {
        ...
        String price_service_url = getServiceUrl("ts-price-service");
        ResponseEntity<Response> re = restTemplate.exchange(price_service_url + "/api/v1/priceservice/prices/byRouteIdsAndTrainTypes", HttpMethod.POST, requestEntity, Response.class);
