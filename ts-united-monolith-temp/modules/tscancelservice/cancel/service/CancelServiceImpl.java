package modules.tscancelservice.cancel.service;
...
public class CancelServiceImpl implements CancelService {
    ...
    public boolean sendEmail(NotifyInfo notifyInfo, HttpHeaders headers) {
        ...
        ResponseEntity<Boolean> re = restTemplate.exchange(notification_service_url + "/api/v1/notifyservice/notification/order_cancel_success", HttpMethod.POST, requestEntity, Boolean.class);
        return re.getBody();
    }
    ...
    private Response cancelFromOrder(Order order, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange(order_service_url + "/api/v1/orderservice/order", HttpMethod.PUT, requestEntity, Response.class);
        return re.getBody();
    }
    ...
    private Response cancelFromOtherOrder(Order order, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange(order_other_service_url + "/api/v1/orderOtherService/orderOther", HttpMethod.PUT, requestEntity, Response.class);
        return re.getBody();
    }
    ...
    public boolean drawbackMoney(String money, String userId, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange((((inside_payment_service_url + "/api/v1/inside_pay_service/inside_payment/drawback/") + userId) + "/") + money, HttpMethod.GET, requestEntity, Response.class);
    ...
    public Response<User> getAccount(String orderId, HttpHeaders headers) {
        ...
        ResponseEntity<Response<User>> re = restTemplate.exchange((user_service_url + "/api/v1/userservice/users/id/") + orderId, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<User>>() {});
        return re.getBody();
    }
    ...
    private Response<Order> getOrderByIdFromOrder(String orderId, HttpHeaders headers) {
        ...
        HttpEntity requestEntity = new HttpEntity(newHeaders);
        String order_service_url = getServiceUrl("ts-order-service");
        ResponseEntity<Response<Order>> re = restTemplate.exchange((order_service_url + "/api/v1/orderservice/order/") + orderId, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<Order>>() {});
        return re.getBody();
    }
    ...
    private Response<Order> getOrderByIdFromOrderOther(String orderId, HttpHeaders headers) {
        ...
        HttpEntity requestEntity = new HttpEntity(newHeaders);
        String order_other_service_url = getServiceUrl("ts-order-other-service");
        ResponseEntity<Response<Order>> re = restTemplate.exchange((order_other_service_url + "/api/v1/orderOtherService/orderOther/") + orderId, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<Order>>() {});
        return re.getBody();
    }
}