package modules.tscancelservice.cancel.controller;
import modules.tscancelservice.cancel.service.CancelService;
...
public class CancelController {
    ...
    public HttpEntity calculate(@PathVariable
    ...
    public HttpEntity cancelTicket(@PathVariable
    String orderId, @PathVariable
    String loginId, @RequestHeader
    HttpHeaders headers) {
