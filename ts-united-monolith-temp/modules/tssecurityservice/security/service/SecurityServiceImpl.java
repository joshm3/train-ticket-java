...
import modules.tssecurityservice.security.repository.SecurityRepository;
...
public class SecurityServiceImpl implements SecurityService {
    ...
    private OrderSecurity getSecurityOrderInfoFromOrder(Date checkDate, String accountId, HttpHeaders headers) {
        ...
        ResponseEntity<Response<OrderSecurity>> re = restTemplate.exchange((((order_service_url + "/api/v1/orderservice/order/security/") + checkDate) + "/") + accountId, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<OrderSecurity>>() {});
    ...
    private OrderSecurity getSecurityOrderOtherInfoFromOrder(Date checkDate, String accountId, HttpHeaders headers) {
        ...
        ResponseEntity<Response<OrderSecurity>> re = restTemplate.exchange((((order_other_service_url + "/api/v1/orderOtherService/orderOther/security/") + checkDate) + "/") + accountId, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<OrderSecurity>>() {});
        Response<OrderSecurity> response = re.getBody();
        OrderSecurity result = response.getData();
