...
public class VoucherService {
    ...
    public Order queryOrderByIdAndType(String orderId, int type) {
        ...
        ResponseEntity<Response<Order>> reGetOrderByRebookInfo = restTemplate.exchange(requestUrl, HttpMethod.GET, requestEntityGetOrderInfo, new ParameterizedTypeReference<Response<Order>>() {});
