...
import modules.tspreserveotherservice.preserveOther.mq.RabbitSend;
...
public class PreserveOtherServiceImpl implements PreserveOtherService {
    ...
    public Response preserve(OrderTicketsInfo oti, HttpHeaders httpHeaders) {
        ...
        if (response.getStatus() == 0) {
            ...
            } else if ((tripResponse.getEconomyClass() == SeatClass.SECONDCLASS.getCode()) && (tripResponse.getConfortClass() == 0)) {
        ...
        ResponseEntity<Response<TravelResult>> re = restTemplate.exchange(basic_service_url + "/api/v1/basicservice/basic/travel", HttpMethod.POST, requestEntity, new ParameterizedTypeReference<Response<TravelResult>>() {});
        ...
        if (oti.getSeatType() == SeatClass.FIRSTCLASS.getCode()) {
            ...
            Ticket ticket = dipatchSeat(oti.getDate(), order.getTrainNumber(), fromStationName, toStationName, SeatClass.FIRSTCLASS.getCode(), firstClassTotalNum, stationList, httpHeaders);
            ...
            Ticket ticket = dipatchSeat(oti.getDate(), order.getTrainNumber(), fromStationName, toStationName, SeatClass.SECONDCLASS.getCode(), secondClassTotalNum, stationList, httpHeaders);
        ...
        if (oti.getAssurance() == 0) {
            ...
            Response<Assurance> addAssuranceResult = addAssuranceForOrder(oti.getAssurance(), cor.getData().getId().toString(), httpHeaders);
    ...
    public Ticket dipatchSeat(String date, String tripId, String startStationId, String endStataionId, int seatType, int totalNum, List<String> stationList, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Ticket>> reTicket = restTemplate.exchange(seat_service_url + "/api/v1/seatservice/seats", HttpMethod.POST, requestEntityTicket, new ParameterizedTypeReference<Response<Ticket>>() {});
    ...
    public User getAccount(String accountId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<User>> getAccount = restTemplate.exchange((user_service_url + "/api/v1/userservice/users/id/") + accountId, HttpMethod.GET, requestEntitySendEmail, new ParameterizedTypeReference<Response<User>>() {});
    ...
    private Response<Assurance> addAssuranceForOrder(int assuranceType, String orderId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Assurance>> reAddAssuranceResult = restTemplate.exchange((((assurance_service_url + "/api/v1/assuranceservice/assurances/") + assuranceType) + "/") + orderId, HttpMethod.GET, requestAddAssuranceResult, new ParameterizedTypeReference<Response<Assurance>>() {});
    ...
    private String queryForStationId(String stationName, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<String>> reQueryForStationId = restTemplate.exchange((station_service_url + "/api/v1/stationservice/stations/id/") + stationName, HttpMethod.GET, requestQueryForStationId, new ParameterizedTypeReference<Response<String>>() {});
    ...
    private Response checkSecurity(String accountId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reCheckResult = restTemplate.exchange((security_service_url + "/api/v1/securityservice/securityConfigs/") + accountId, HttpMethod.GET, requestCheckResult, Response.class);
    ...
    private Response<TripAllDetail> getTripAllDetailInformation(TripAllDetailInfo gtdi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<TripAllDetail>> reGetTripAllDetailResult = restTemplate.exchange(travel2_service_url + "/api/v1/travel2service/trip_detail", HttpMethod.POST, requestGetTripAllDetailResult, new ParameterizedTypeReference<Response<TripAllDetail>>() {});
    ...
    private Response<Contacts> getContactsById(String contactsId, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Contacts>> reGetContactsResult = restTemplate.exchange((contacts_service_url + "/api/v1/contactservice/contacts/") + contactsId, HttpMethod.GET, requestGetContactsResult, new ParameterizedTypeReference<Response<Contacts>>() {});
    ...
    private Response<Order> createOrder(Order coi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response<Order>> reCreateOrderResult = restTemplate.exchange(order_other_service_url + "/api/v1/orderOtherService/orderOther", HttpMethod.POST, requestEntityCreateOrderResult, new ParameterizedTypeReference<Response<Order>>() {});
    ...
    private Response createFoodOrder(FoodOrder afi, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reAddFoodOrderResult = restTemplate.exchange(food_service_url + "/api/v1/foodservice/orders", HttpMethod.POST, requestEntityAddFoodOrderResult, Response.class);
    ...
    private Response createConsign(Consign cr, HttpHeaders httpHeaders) {
        ...
        ResponseEntity<Response> reResultForTravel = restTemplate.exchange(consign_service_url + "/api/v1/consignservice/consigns", HttpMethod.POST, requestEntityResultForTravel, Response.class);
