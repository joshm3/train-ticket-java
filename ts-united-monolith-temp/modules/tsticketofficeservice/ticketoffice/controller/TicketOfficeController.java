package modules.tsticketofficeservice.ticketoffice.controller;
import java.util.Map;
import modules.tsticketofficeservice.ticketoffice.entity.Office;
import modules.tsticketofficeservice.ticketoffice.service.impl.TicketOfficeService;
...
public class TicketOfficeController {
    ...
    public ResponseEntity<?> getSpecificOffices(@RequestBody
    ...
    public ResponseEntity<?> addOffice(@RequestBody
    Map<String, Object> data) {
        logger.info("TicketOfficeService addOffice");
        @SuppressWarnings("unchecked")
        Map<String, Object> office = ((Map<String, Object>) (data.get("office")));
    ...
    public ResponseEntity<?> deleteOffice(@RequestBody
    Map<String, String> data) {
    ...
    public ResponseEntity<?> updateOffice(@RequestBody
    Map<String, Object> data) {
        logger.info("TicketOfficeService updateOffice");
        @SuppressWarnings("unchecked")
        Map<String, Object> office = ((Map<String, Object>) (data.get("newOffice")));
        Office newOffice = new Office(((String) (office.get("name"))), ((String) (data.get("city"))), ((String) (data.get("province"))), ((String) (data.get("region"))), ((String) (office.get("address"))), ((String) (office.get("workTime"))), ((int) (office.get("windowNum"))));
