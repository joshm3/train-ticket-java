package modules.tstrainfoodservice.trainFood.controller;
import modules.tstrainfoodservice.trainFood.service.TrainFoodService;
...
public class TrainFoodController {
    ...
    public HttpEntity getAllTrainFood(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getTrainFoodOfTrip(@PathVariable
