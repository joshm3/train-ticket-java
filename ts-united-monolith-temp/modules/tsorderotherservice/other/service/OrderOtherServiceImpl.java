...
public class OrderOtherServiceImpl implements OrderOtherService {
    ...
    public List<String> queryForStationId(List<String> ids, HttpHeaders headers) {
        ...
        ResponseEntity<Response<List<String>>> re = restTemplate.exchange(station_service_url + "/api/v1/stationservice/stations/namelist", HttpMethod.POST, requestEntity, new ParameterizedTypeReference<Response<List<String>>>() {});
