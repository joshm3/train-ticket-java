package modules.tstravelservice.travel.service;
...
import modules.tstravelservice.travel.entity.AdminTrip;
import modules.tstravelservice.travel.entity.Travel;
import modules.tstravelservice.travel.entity.Trip;
import modules.tstravelservice.travel.entity.TripAllDetail;
import modules.tstravelservice.travel.repository.TripRepository;
...
public class TravelServiceImpl implements TravelService {
    ...
    public Response create(TravelInfo info, HttpHeaders headers) {
        ...
        if (repository.findByTripId(ti) == null) {
            Trip trip = new Trip(ti, info.getTrainTypeName(), info.getStartStationName(), info.getStationsName(), info.getTerminalStationName(), info.getStartTime(), info.getEndTime());
    ...
    private List<TripResponse> getTicketsByBatch(List<Trip> trips, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        ResponseEntity<Response> re = restTemplate.exchange(basic_service_url + "/api/v1/basicservice/basic/travels", HttpMethod.POST, requestEntity, Response.class);
    ...
    private TripResponse getTickets(Trip trip, Route route1, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        String basic_service_url = getServiceUrl("ts-basic-service");
        ResponseEntity<Response> re = restTemplate.exchange(basic_service_url + "/api/v1/basicservice/basic/travel", HttpMethod.POST, requestEntity, Response.class);
        Response r = re.getBody();
        if (r.getStatus() == 0) {
    ...
    private TrainType getTrainTypeByName(String trainTypeName, HttpHeaders headers) {
        ...
        ResponseEntity<Response<TrainType>> re = restTemplate.exchange((train_service_url + "/api/v1/trainservice/trains/byName/") + trainTypeName, HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<TrainType>>() {});
