...
public class ConsignServiceImpl implements ConsignService {
    ...
    public Response insertConsignRecord(Consign consignRequest, HttpHeaders headers) {
        ...
        ResponseEntity<Response<Double>> re = restTemplate.exchange((((consign_price_service_url + "/api/v1/consignpriceservice/consignprice/") + consignRequest.getWeight()) + "/") + consignRequest.isWithin(), HttpMethod.GET, requestEntity, new ParameterizedTypeReference<Response<Double>>() {});
