package modules.tsfoodservice.foodsearch.controller;
...
import modules.tsfoodservice.foodsearch.service.FoodService;
...
public class FoodController {
    ...
    public HttpEntity findAllFoodOrder(@RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity createFoodOrder(@RequestBody
    ...
    public HttpEntity createFoodBatches(@RequestBody
    List<FoodOrder> foodOrderList, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity updateFoodOrder(@RequestBody
    FoodOrder updateFoodOrder, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity deleteFoodOrder(@PathVariable
    ...
    public HttpEntity findFoodOrderByOrderId(@PathVariable
    String orderId, @RequestHeader
    HttpHeaders headers) {
    ...
    public HttpEntity getAllFood(@PathVariable
    String date, @PathVariable
    String startStation, @PathVariable
    String endStation, @PathVariable
