package modules.tsavatarservice.avatar.controller;
import java.util.Base64;
import java.util.Map;
import modules.tsavatarservice.avatar.service.impl.AvatarService;
...
public class AvatarController {
    ...
    @PostMapping
    public ResponseEntity<String> processAvatar(@RequestBody
